...
jejich kompletní výsledky, si můžete prohlédnou v podadresaři \texttt{output_v2/}.

\paragraph{Celodenní režim (\texttt{24h}) s rozšířenou infrastrukturou o 80kWh a 160kWh nabíječky:}
