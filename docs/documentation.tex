...
proč křivka pro AC vypadá tak jak vypadá + popis fází.
...
\begin{figure}[H]
    ...
    \caption{Efektivita nabíjení pomocí střídavého proudu \cite{rozdil_mezi_ac_dc_nabijenim_graf}}
    \label{figure:ac-charging-efficency}
\end{figure}

\subsubsection{Nabíjení pomocí stejnosměrného proudu}
TODO Popis jak křivka vypadá a jak se došlo k hodnotám v tabulkách tedy k průměrnému nabíjecímu výkonu,
proč křivka pro DC vypadá tak jak vypadá + popis fází.
...
\begin{figure}[H]
    ...
    \caption{Efektivita nabíjení pomocí stejnosměrného proudu \cite{rozdil_mezi_ac_dc_nabijenim_graf}}
